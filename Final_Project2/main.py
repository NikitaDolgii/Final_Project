...
# загрузка кнопок улучшений в одиночной игре
...
wall_vertical = pygame.image.load('wall_vertical_10x50.png').convert_alpha()
wall_vertical_rect = []
...
wall_horizontal = pygame.image.load('wall_horizontal_50x10.png').convert_alpha()
